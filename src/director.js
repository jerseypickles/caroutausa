...
- OVERSIZED BOXY SILHOUETTE IS CRITICAL (this is what makes it look stylish and on-trend, and drives CTR): the TOP and layers must be clearly OVERSIZED, BOXY and RELAXED — the current streetwear fit. Big drop-shoulder hoodies, boxy heavyweight tees, oversized knits, roomy jackets that drape. NEVER slim, fitted, tight or tucked tops — a tight/fitted top reads dated and cheap. Think generous, baggy, drapey proportions up top.
